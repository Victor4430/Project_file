! function() {
	...
	! function(n) {
		...
		if (p) {
			var m, g, h = p.getAttribute.bind(p),
				y = h("data-website-id"),
				w = h("data-host-url"),
				...
				O = w ? (m = w) && m.length > 1 && m.endsWith("/") ? m.slice(0, -1) : m : p.src.split("/").slice(0, -1)
				.join("/"),
				j = i + "x" + r,
				L = {},
				_ = "" + u + l,
				...
				J = function(t, e) {
					A() || function(t, e, n) {
						...
						a.open("POST", t, !0), a.setRequestHeader("Content-Type", "application/json"), g && a
							.setRequestHeader("x-umami-cache", g), a.onreadystatechange = function() {
				...
				M = function(t, e, n) {
					void 0 === t && (t = _), void 0 === e && (e = x), void 0 === n && (n = y), J("pageview", R(H(), {
						website: n,
						url: t,
						referrer: e
					}))
				...
				P = function(t, e, n, a) {
					void 0 === e && (e = "custom"), void 0 === n && (n = _), void 0 === a && (a = y), J("event", R(
				H(), {
						website: a,
						url: n,
						event_type: e,
					...
					(t.getAttribute("class") || "").split(" ").forEach((function(e) {
						if (T.test(e)) {
							var n = e.split("--"),
								a = n[1],
								i = n[2],
								r = L[e] ? L[e] : L[e] = function() {
									"A" === t.tagName ? function(t, e) {
										var n = H();
			...
			if (b && !A()) {
				...
				var I = function() {
					"complete" === f.readyState && (M(), k && (z(f), new MutationObserver((function(t) {
