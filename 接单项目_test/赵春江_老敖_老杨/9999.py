#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :py_venv -> 9999.py
# @IDE       :PyCharm
# @Time      :2022/4/11 22:30
# @Author    :杨晓东
...
def run():
    # 设置开始网址
    url = "https://www.amazon.com/sp?ie=UTF8&seller=A3VT9VLIG8GZLW&isAmazonFulfilled=1"
    # 设置代理端口
    ...
    test = html.xpath('/html/body/div[1]/div[2]/div[2]/div/h3/text()')[0]
    print(test, '访问成功！')
