...
class HongZha:
    ...
    def youzan(self, name):
        try:
            ...
            driver.implicitly_wait(10)
            driver.find_element_by_xpath('//*[@id="app"]/div/div[1]/div[1]/div/form/div[1]/div[2]/input').send_keys(
                self.phone)
    ...
    def huaweiyun(self, name):
        ...
        driver.find_element_by_xpath('//*[@id="registerForm"]/div/div[2]/div[1]/div[2]/div[1]/div[3]/input').send_keys(
            self.phone)
        button = driver.find_element_by_xpath(
            '//*[@id="registerForm"]/div/div[2]/div[1]/div[4]/div[1]/div[2]/div/div/div')
        self.send_yzm(button, name)
